...
import com.example.trafficnewsandrules.Interfaces.ReportInterface;
...
public class ReportView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                addImage(bitmap);
                Toast.makeText(ReportView.this, "Image Confirmed", Toast.LENGTH_SHORT).show();
            }
        });

        add = findViewById(R.id.btnAddReport);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (nullValidation()) {
                    ...
                    Report report = new Report(stitle,simageName,sdesc);
                    ...
                    Call<Void> call = (Call<Void>) reportInterface.addReport(report);
    ...
    private void addImage(Bitmap bitmap) {
        ...
        try {
            ...
            ReportInterface reportInterface = retrofit.create(ReportInterface.class);
            Call<ImageUploads> imgCall = reportInterface.uploadImage(body);
